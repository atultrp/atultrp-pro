...
const ProjectItem = ({ projectInfo }) => {
  return (
      <div className="sm:w-[320px] p-4">
        <div className="flex relative">
          <img alt="project Image" className="absolute inset-0 w-full h-[198px] object-cover object-center rounded-3xl shadow-md shadow-gray-400" src={projectInfo.imgSrc} />
          <div className="px-4 py-3 relative z-10 w-full h-[198px] border-4 border-gray-200 bg-[#004c53] text-white opacity-0 hover:opacity-100 backdrop-blur-2xl transition-opacity duration-300 rounded-3xl">
